...
(async () => {
  ...
  const PW = 'theisland4!'
  await page.screenshot({path: '로그인 전.png'})    
  console.log('스샷찍음ㅇㅇ')
  //facebook
  ...
  //apple
  // const emailSelector = "#sign_in_form > div > div > div.account-name.form-row.show-password > div > div > #account_name_text_field"
  // const passSelector = "#sign_in_form > div > div > div.account-name.form-row.show-password > div > div > #password_text_field"

  // google
  // const emailSelector = "#yDmH0d > c-wiz > div > div.eKnrVb > div > div.j663ec > div > form > span > section > div > div > div.d2CFce.cDSmF.cxMOTc > div > div.aCsJod.oJeWuf > div > div.Xb9hP > #identifierId"
  // const passSelector = "#password > div.aCsJod.oJeWuf > div > div.Xb9hP > input"
  ...
  await page.screenshot({path: '아이디 입력 완료.png'})    
  console.log('스샷찍음ㅇㅇ')

  await page.waitForTimeout(5000); // 5초 대기
  await page.screenshot({path: '비번 입력 대기.png'})    
  console.log('스샷찍음ㅇㅇ')
  await page.waitForSelector(passSelector,  { timeout: 60000 })
  await page.type(passSelector, PW)
  await page.screenshot({path: '입력 완료.png'})    
  console.log('스샷찍음ㅇㅇ')
  await page.keyboard.press('Enter')
  await page.waitForNavigation({ waitUntil: 'networkidle0' })
  await page.screenshot({path: '엔터 누르고 페이지 전환.png'})    
  console.log('스샷찍음ㅇㅇ')
  // 로그인 처리
